...
@interface ScoreRankViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
- (UICollectionViewCell *)collectionView :(UICollectionView *) collectionView cellForItemAtIndexPath:( NSIndexPath *)indexPath {
    ...
    cell.rankLabel.text = [NSString stringWithFormat:@"%d",indexPath.row +4];
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    if ([kind isEqualToString:UICollectionElementKindSectionHeader]) {
        ...
        _headView.attentionLeftLabel.hidden = YES;
        _headView.attentionMiddleLabel.hidden = YES;
        _headView.attentionRightLabel.hidden = YES;
